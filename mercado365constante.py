...
def generacion0 (numeroP):# PARA COMENZAR, EN LA GENERACION 0, 
    ...
    for P in range(numeroP): 
       # las compradores heredan los atributos y los grados de libertad de los padres
        ...
        comprador=[P,
               ...
               1 - ((1 / 16) * (28 - 23)), # 23, conectividad 5G, wifi, bluetooth,
               1 - ((1 / 16) * (23 - 23)), # 24, duracion de la bateria                  
               1 - ((1 / 16) * (34 - 23)), # 25, funciones inteligencia artificial
               1 - ((1 / 16) * (33 - 23)), # 26, ecocertificacion, sostenibilidad
               1 - ((1 / 16) * (30 - 23)), # 27, seguridad y privacidad
               1 - ((1 / 16) * (24 - 23)), # 28, camara y software de video
               1 - ((1 / 16) * (25 - 23)), # 29, memoria
               1 - ((1 / 16) * (29 - 23)), # 30, resolución y tamaño de pantalla
               1 - ((1 / 16) * (35 - 23)), # 31, realidad aumentada y realidad virtual
               1 - ((1 / 16) * (32 - 23)), # 32, integracion con otros sensores y dispositivos
               1 - ((1 / 16) * (26 - 23)), # 33, diseño y estética
               1 - ((1 / 16) * (36 - 23)), # 34, sensores integrados IoT 
               1 - ((1 / 16) * (31 - 23)), # 35, usabilidad y ergonomía
               1 - ((1 / 16) * (37 - 23)), # 36, sensores y funcionalidades de bienestar y salud
               1 - ((1 / 16) * (27 - 23)), # 37, funcionalidades adicionales
               1 - ((1 / 16) * (38 - 23)), # 38, accesorios disponibles 
               tiemposP,
               None
               ]
    ...
    for D in range(numeroD):
        ...
        vendedor = [D,# cada vendedor tiene su lista de valores iniciales
                      ...
                      1 - ((1 / 16) * (30 - 23)), # 23, conectividad 5G, wifi, bluetooth,
                      1 - ((1 / 16) * (28 - 23)), # 24, duracion de la bateria                  
                      1 - ((1 / 16) * (31 - 23)), # 25, funciones inteligencia artificial
                      1 - ((1 / 16) * (27 - 23)), # 26, ecocertificacion, sostenibilidad
                      1 - ((1 / 16) * (32 - 23)), # 27, seguridad y privacidad
                      1 - ((1 / 16) * (23 - 23)), # 28, camara y software de video
                      1 - ((1 / 16) * (24 - 23)), # 29, memoria
                      1 - ((1 / 16) * (25 - 23)), # 30, resolución y tamaño de pantalla
                      1 - ((1 / 16) * (33 - 23)), # 31, realidad aumentada y realidad virtual
                      1 - ((1 / 16) * (29 - 23)), # 32, integracion con otros sensores y dispositivos
                      1 - ((1 / 16) * (26 - 23)), # 33, diseño y estética
                      1 - ((1 / 16) * (34 - 23)), # 34, sensores integrados IoT 
                      1 - ((1 / 16) * (35 - 23)), # 35, usabilidad y ergonomía
                      1 - ((1 / 16) * (36 - 23)), # 36, sensores y funcionalidades de bienestar y salud
                      1 - ((1 / 16) * (37 - 23)), # 37, funcionalidades adicionales
                      1 - ((1 / 16) * (38 - 23)), # 38, accesorios disponibles 
            ...
            for i in intcomun:  # Campos no 0 entre 23 y 38 (inclusive) 
                ...
                if comprador[i] != 0 and vendedor[i] != 0:
                    if vendedor[i] > comprador[i]: # el vendedor asigna un precio a la memoria mayor al que el comprador aprecia como valor
                        ...
                        contadorD += (vendedor[i]-comprador[i]) * (1 - ((1 / 16) * (i - 23))) #tener mas atributos sube el contador ante el que tenga menos, aunque sean de mas valor                 
                        ...
                        contadorP += (comprador[i]-vendedor[i]) * (1 - ((1 / 16) * (i - 23)))
...
generaciones = 366 # NUMERO DE GENERACIONES
...
folder_path = "mercado365constante"
